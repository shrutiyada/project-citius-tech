...
import { Upload, FileText, CheckCircle, XCircle, Clock, Activity, MessageSquare, Mic, Search, ChevronRight } from 'lucide-react';
            ...
            {patientEntities && (
              <div style={{ marginTop: '24px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px' }}>
                  ...
                  <span className="badge info"><Clock size={12} style={{marginRight: '4px'}}/> {patientEntities.processing_time_seconds}s Latency</span>
                </div>
          ...
          <div className="glass-panel">
            ...
            {policyEntities && (
              <div style={{ marginTop: '24px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px' }}>
                  <span className="badge success">Extraction Complete</span>
                  <span className="badge info"><Clock size={12} style={{marginRight: '4px'}}/> {policyEntities.processing_time_seconds}s Latency</span>
                </div>
                <div style={{ background: 'rgba(0,0,0,0.2)', padding: '12px', borderRadius: '8px', maxHeight: '200px', overflowY: 'auto' }}>
            ...
            <>
              ...
              <div className="grid-4">
                ...
                <div className="glass-panel" style={{ textAlign: 'center' }}>
                  ...
                  <h2 style={{ fontSize: '32px', margin: '8px 0', color: evaluation.audit_status === 'PASS' ? '#10b981' : '#f59e0b' }}>
                    {evaluation.audit_status}
                  </h2>
                </div>
                <div className="glass-panel" style={{ textAlign: 'center' }}>
                  <p style={{ color: 'var(--text-muted)', fontSize: '12px' }}>RAGAS Faithfulness</p>
                  <h2 style={{ fontSize: '32px', margin: '8px 0', color: 'var(--primary)' }}>{evaluation.ragas_metrics?.faithfulness || 'N/A'}%</h2>
                </div>
                <div className="glass-panel" style={{ textAlign: 'center' }}>
                  <p style={{ color: 'var(--text-muted)', fontSize: '12px' }}>Total Latency</p>
                  <h2 style={{ fontSize: '32px', margin: '8px 0', color: 'var(--primary)' }}>{evaluation.processing_time_seconds}s</h2>
                </div>
              </div>
      ...
      {activeTab === 'chat' && (
        <div className="glass-panel chat-window">
          ...
          <form className="chat-input-area" onSubmit={handleChatSubmit}>
            ...
            />
            <button type="button" className="btn btn-outline"><Mic size={16}/></button>
